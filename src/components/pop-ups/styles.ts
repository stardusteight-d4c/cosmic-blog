...
export const chooseAvatarPopUpStyles = {
  ...
  arrowLeft: `absolute -left-10 top-1/2 -translate-y-1/2 text-[#F2F2F2]/80 cursor-pointer -rotate-180`,
  arrowRight: `absolute -right-10 top-1/2 -translate-y-1/2 text-[#F2F2F2]/80 cursor-pointer`,
  handleAvatarsImage: (
    ...
    return {
      ...
      'w-24 p-2 col-span-1 cursor-pointer transition-all ease-in-out duration-300 hover:bg-[#F2F2F2]/5 rounded-md':
        true,
    }
  },
