...
export default defineComponent({
  ...
  setup() {
    ...
    const changeToSignInObesver = (payload: 'SignIn') => {
      typeOfLogin.value = payload
    }

    return {
      typeOfLogin,
      changeToSignInObesver
    }
  },
})
</script>
...
<template>
  ...
  >
    ...
    <div class="max-w-[725px] relative min-h-screen w-full mx-auto">
      <Navbar path="login" />
      <SignUp @changeToSignIn="changeToSignInObesver" v-if="typeOfLogin === 'SignUp'" />
      <div
      ...
      >
        <form>
          <div class="text-center mb-8">
            ...
            <span
              class="text-center inline-block text-lg text-[#F2F2F2]/70 mt-2"
              >Don't have an account?
              <span
                class="text-blue-500 hover:underline cursor-pointer"
                @click="typeOfLogin = 'SignUp'"
                >Sign Up</span
              >
            </span>
          </div>
          <div class="flex items-center gap-x-4">
            <div class="form-control">
              ...
              <label>
                ...
                <span style="transition-delay: 50ms">or</span>
          ...
          <button
            type="submit"
            class="w-fit text-xl mx-auto mt-8 font-semibold"
          >
          Sign In
          </button>
        </form>
