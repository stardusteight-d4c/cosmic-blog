...
import { PostService, PostSubscriber } from "@domain/aggregates/post";
import { UserService, UserSubscriber } from "@domain/aggregates/user";
import { CommentService, CommentSubscriber } from "@domain/aggregates/comment";
import { FavoriteService, FavoriteSubscriber } from "@domain/aggregates/favorite";
